...
function SkillsGuid() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#31B29C]/10 flex flex-col items-center py-8 px-2">
      ...
      <div className="w-full max-w-3xl bg-white rounded-3xl shadow-2xl border-2 flex flex-col md:flex-row items-center p-6 md:p-10 mb-8 relative" style={{ borderColor: MAIN_COLOR }}>
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-3 md:pl-8">
          ...
          <div className="bg-[#31B29C]/20 border-l-4 border-[#31B29C] p-3 rounded-xl text-gray-800 text-md font-medium shadow-sm mb-2">
